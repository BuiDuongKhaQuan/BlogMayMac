...
<head>
    ...
    <title>Đăng ký &mdash; Nhóm 12</title>
    <!-- Bootstrap -->
            ...
            <div class="box box-border">
                <div class="box-body">
                    ...
                    <form action="register" method="post">
                        ...
                        <div class="form-group">
                            <label class="fw">Nhập lại mật khẩu</label>
                        ...
                        %>
                        <div class="form-group">
                            <label class="fw" style="color: red"><%=mess%></label>
                        </div>
                        <%}%>
                        ...
                        <div class="form-group text-center">
                            <span class="text-muted">Bạn có sẵn sàn để tạo một tài khoản?</span> <a
