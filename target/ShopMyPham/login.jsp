...
<head>
    ...
    <title>Đăng nhập &mdash; Nhóm 12</title>
    <!-- Bootstrap -->
        ...
        <div class="box-wrapper">
            <div class="box box-border">
                <div class="box-body">
                    ...
                    <%--
                    Usecase Comment
                    4.4. Người dùng đăng nhập và quay lại từ bước 1
                    --%>
                    <form action="login" method="post">
                        ...
                        %>
                        <div class="form-group">
                            <label class="fw" style="color: red"><%=mess%>
                            </label>
                        </div>
                        <%}%>
                        ...
                        <div class="form-group text-center">
                            <span class="text-muted">Bạn chưa có tài khoản?</span> <a href="register.jsp">Tạo tài
                            khoản</a>
                        </div>
                        <div class="title-line">
                            hoặc
                        </div>
                        <a href="#" class="btn btn-social btn-block facebook"><i class="ion-social-facebook"></i> Đăng
                            nhập bằng Facebook</a>
                        <a href="#" class="btn btn-social btn-block facebook"><i class="ion-social-googleplus"></i> Đăng
                            nhập bằng Google</a>
                    </form>
                </div>
            </div>
